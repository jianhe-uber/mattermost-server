...
// GetSchemeRolesForChannel Checks if a channel or its team has a scheme and returns the scheme roles or default channel roles.
...
// GetTeamSchemeRolesForChannel Checks if a team has a scheme and returns the scheme channel roles or default channel roles
